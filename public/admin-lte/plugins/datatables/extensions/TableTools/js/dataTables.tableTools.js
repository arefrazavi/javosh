 ...
 * @version     2.2.4
 * @comment        dataTables.tableTools.js
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	fileName: '', // default comment save name
...
TableTools.prototype = {
	...
	/**
	 * Get the title of the document - useful for comment names. The title is retrieved from either
	...
	"_fnRowSelectConfig": function ()
	{
		if ( this.s.master )
		{
			...
			$(dt.nTBody).on( 'click.DTTT_Select', this.s.custom.sRowSelector, function(e) {
				...
				// row selection a lot like a comment system in desktop OSs
				if ( select.type == 'os' ) {
