        ...
        <div class="col-lg-12">
            <div class="box box-default">
                <div class="box-header ui-sortable-handle" style="cursor: move;">
                    ...
                    <h3 class="box-title rtl-text">@lang('common.Product_Introduction')</h3>
                </div>
            ...
            <div class="box box-success">
                ...
                @foreach($aspects as $aspect)
                    <div class="box box-default">
                        <h4 class="box-header aspect-header cursor-hand" data-toggle="popover" data-placement="top" title="@lang('common.keywords')" data-content="{{ $aspect->keywords }}">
